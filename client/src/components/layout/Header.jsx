...
export function Header({
  ...
  return (
    <header data-tour="header" ref={headerRef} className={styles.header}>
      {/* Logo + Titre */}
      ...
      <div className={styles.mobileRight}>
        ...
        <button className={styles.helpBtn} onClick={onStartTour} title="Guide interactif" aria-label="Aide">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/><path d="M9 9a3 3 0 0 1 5.83 1c0 2-3 2-3 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><circle cx="12" cy="18" r="0.5" fill="currentColor" stroke="currentColor" strokeWidth="1"/></svg>
        </button>
      </div>
